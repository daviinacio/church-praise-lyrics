...
export default function SEO({ title, description, children }) {
  const siteName = "Praise Ministry";

  return (
    <Head>
      <meta name="application-name" content="Church Praise Lyrics" />
      <meta name="apple-mobile-web-app-capable" content="yes" />
      <meta name="apple-mobile-web-app-status-bar-style" content="default" />
      <meta name="apple-mobile-web-app-title" content="Church Praise Lyrics" />
      ...
      <title>
        {(typeof title !== "undefined" ? title + " · " : "") + siteName}
      </title>
      ...
      <meta
        property="og:url"
        content={"https://church-praise-lyrics.vercel.app/"}
      />
